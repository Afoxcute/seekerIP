...
async function main() {
  console.log("🎨 Creating HTS NFT Collection with Correct Addresses...");
  console.log("======================================================");
  ...
  try {
    ...
    // The contract is owned by IPAssetManagerV2, so we need to call it through the manager
    // But first, let's check if the deployer can call it directly
    console.log("📋 Attempting direct call to IPAssetHTSKYC...");
